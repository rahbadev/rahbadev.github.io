 ...
 * من shared_core بدلاً من تكرار البيانات
 */

class MainSiteHelper {
    constructor() {
        this.dataLoader = new DataLoader('../shared_core/data');
    }
    ...
    applyCentralizedStyles() {
        ...
        const hasVariables = document.querySelector('link[href*="shared_core/css/variables.css"]');
        const hasComponents = document.querySelector('link[href*="shared_core/css/components.css"]');
